...
class BookControllerTests {
    ...
    Book book1 = new Book(1, "Testing with Mockito", "Programming", "Editorial ABC", (short) 254, "ESP", "Pepito Perez",
            LocalDate.of(2021, 1, 1), "123456789", true);
    Book book2 = new Book(2, "Testing with Mockito", "Programming", "Editorial EFG", (short) 250, "ENG", "Jhon Smith",
            LocalDate.of(2023, 5, 5), "987654321", true);
    Book book3 = new Book(3, "Testing with JUnit", "Programming", "Editorial ABC", (short) 280, "ESP", "Pepito Perez",
